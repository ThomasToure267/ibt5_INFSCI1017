...
public class Genre {
	...
	public Genre(int genreID) {
		...
		this.genreID = genreID;//setting class property genreID
		db = new DbUtilities();
	...
	public Genre(String genreName,String description) {
		db = new DbUtilities();
		this.genreName = genreName;//setting class property genreName
		this.description = description;//setting class property description
