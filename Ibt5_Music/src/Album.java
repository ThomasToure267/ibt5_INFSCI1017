...
* Sets corresponding class properties
 */
public void addSong(Map<String, Song> albumSongs) {
	
	
	db = new DbUtilities();
	this.albumSongs =  albumSongs;
	String sql3 = "INSERT INTO album_song (fk_album_id,fk_song_id) VALUES  ('" + albumID+"', '"+albumSongs+"');";
...
public void deleteSong(String songID) {
	...
	db = new DbUtilities();
	String sql4 = "DELETE FROM album_song WHERE fk_album_id = "+ albumID+" AND fk_song_id"+songID+";";
...
public void deleteSong(Song song) {
	...
	db = new DbUtilities();
	String sql5 = "DELETE FROM album_song WHERE fk_song_id  "+ song.getsongID()+" AND fk_album_id"+albumID+";";
